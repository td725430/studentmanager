    ...
    <div class="center-layout">
        ...
        <table>
            ...
            <tr>
                ...
                <td class="td-right">
                    <input type="text" name="id" id="id" value="${requestScope.student.id}" readonly/>
            ...
            <tr>
                ...
                <td class="td-right">
                    <input type="name" name="name" id="name" value="${requestScope.student.name}"/>
            ...
            <tr>
                ...
                <td class="td-right">
                    <input type="date" name="birthday" id="birthday" value="${requestScope.student.birthday}"/>
            </tr>
            <tr>
                <td class="td-left">
                ...
                <td class="td-right">
                    <input type="text" name="description" id="description" value="${requestScope.student.description}"/>
            ...
            <tr>
                ...
                <td class="td-right">
                    <input type="text" name="avgscore" id="avgscore" value="${requestScope.student.avgscore}"/>
